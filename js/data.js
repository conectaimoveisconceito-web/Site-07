...
var FAQ = [
  ...
  { pergunta: "Preciso ter dinheiro para dar de entrada?", resposta: "Sim, normalmente é necessário ter uma entrada, mas você não precisa necessariamente ter todo o valor disponível de uma vez. Dependendo do empreendimento, existem condições com entrada facilitada e possibilidade de parcelamento. O FGTS também pode ser utilizado, quando permitido pelas regras do financiamento." },
  { pergunta: "Posso usar meu FGTS para comprar um imóvel?", resposta: "Sim. O FGTS pode ser utilizado para compra de imóvel, desde que o comprador atenda às regras do programa e às condições estabelecidas para utilização do fundo. A Caixa Econômica Federal realiza a análise e confirma se o cliente está apto a utilizar o FGTS no financiamento." },
